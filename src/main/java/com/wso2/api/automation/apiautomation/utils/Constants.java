...
public class Constants {
    ...
    public static final String INLINE_API_DEFINITION = "inlineAPIDefinition";
    public static final String FILE_API_DEFINITION = "file";
    ...
    public static final String[] THROTTLING_POLICIES = new String[]{"Bronze", "Gold", "Silver", "Unlimited"};
